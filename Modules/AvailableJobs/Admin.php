...
namespace Modular\Modules\AvailableJobs;
 ...
 *
 * @package Modular\Modules\AvailableJobs
 */
class Admin
{
    ...
    public function get_fields()
    {
        ...
        return array(
            'key' => 'group_5fcd0ddca09bd',
            'title' => ucwords(str_replace(array('-', '_'), ' ', $this->name())),
            'fields' => array(
                array(
                    'key' => 'field_5fcd0e6ecb4f8',
                    'label' => 'Selector',
                    'name' => 'selector',
                    'type' => 'button_group',
                    'instructions' => '',
