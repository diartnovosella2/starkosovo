...
class Admin
{
    ...
    public function get_fields()
    {
        ...
        return array(
            'key' => 'group_5fa807d14593c',
            'title' => 'FAQ and Participate',
            'fields' => array(
                array(
                    'key' => 'field_5fa807ee11067',
                    'label' => 'Choose design',
                    'name' => 'choose_design',
                    'type' => 'button_group',
                    'instructions' => '',
                ...
                array(
                    'key' => 'field_5fa809061106c',
                    'label' => 'Subtitle of FAQ',
                    'name' => 'subtitle_of_faq',
                    'type' => 'text',
                    'instructions' => '',
                    'required' => 0,
                ...
                array(
                    'key' => 'field_5fa809101106d',
                    'label' => 'Subtitle URL of Faq',
                    'name' => 'subtitle_url_of_faq',
                    'type' => 'url',
                    'instructions' => '',
                    'required' => 0,
                    'conditional_logic' => array(
                ...
                array(
                    'key' => 'field_5fa814dbf6921',
                    'label' => 'Subtitle text of FAQ',
                    'name' => 'subtitle_text_of_faq',
                    'type' => 'text',
                    'instructions' => '',
                    'required' => 0,
                    'conditional_logic' => array(
